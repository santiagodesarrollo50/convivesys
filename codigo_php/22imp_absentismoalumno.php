...
$pdf->SetColorRellenoCabeceras('165, 105, 189');
  ...
  //Imprime en pantalla los partes del alumno seleccionado
   ...
   $text="RESUMEN MENSUAL DE FALTAS DE ASISTENCIA DEL PRESENTE CURSO ESCOLAR:";
   ...
   $pdf->Output('D',utf8_decode('Registros de absentismo del alumno '.$Iniciales.' ('.$Unidad.').pdf'));
   header('location:01absentismoalumno.php'); 
